...
<form method="post"  style="width:60%;">
	...
	<div class="row">
		...
		<div class="col-sm-5">
		<input type="text" name="sub" class="form-control" value="<?= $row['topic'];?>" /></div>
	</div>
	...
	<div class="row" style="margin-top:10px">
		...
		<input type="reset" class="btn btn-success"/>
            &nbsp;&nbsp;<a href="index.php?page=notification"><input type="button" value="Go back" class="btn btn-success"/></a>
		</div>
	</div>
...
<?php
    if(isset($_POST['submit']))
    {
       ...
       $date= date("d-m-Y");
        ...
        //insert
        $query = mysqli_query($con, "UPDATE `notice` SET `topic` = '$text', `des` = '$des' WHERE `notice`.`id` ='$id'");
