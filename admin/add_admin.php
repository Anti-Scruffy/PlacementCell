...
<form method="post"  style="width:50%;">
	...
	<div class="row">
		<div class="col-sm-4">Email of Admin:</div>
		<div class="col-sm-5">
		<input type="email" name="uname" class="form-control" placeholder="Email ID"/></div>
	</div>
	...
	<div class="row" style="margin-top:10px">
		...
		<div class="col-sm-2"></div>
		<div class="col-sm-4">
		<input type="submit" value="Add New Admin" name="submit" class="btn btn-success" />
...
<?php
    if(isset($_POST['submit']))
    {
        ...
        //insert
        $query = mysqli_query($con, "INSERT INTO admin (user,pass) VALUES ('$user','$pass')");
       
         if($query)
    {
           
            echo "<script type ='text/javascript'>alert(' Admin Added :)'); window.location='index.php';</script>"; 
