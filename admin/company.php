...
<form method="post"  style="width:60%;" enctype="multipart/form-data">
	...
	<div class="row">
		...
		<div class="col-sm-5">
            <input type="text" name="cname" class="form-control"/></div><br />
    ...
    <div class="row">
		...
		<div class="col-sm-5">
		<input type="text" name="jpro" class="form-control" placeholder="Profile"/></div>
	</div><br />
	...
	<div class="row">
		...
		<div class="col-sm-5">
		<input type="text" name="ec" class="form-control"/></div>
	</div>
    ...
    <div class="row">
		...
		<div class="col-sm-5">
		<input type="number" name="pac" class="form-control" placeholder="Per-Annum"/></div>
	</div>
    ...
    <div class="row">
		...
		<div class="col-sm-5">
		<input type="date" name="date" id="date" min="2017-01-02" max="2020-12-31" class="form-control"/></div>
	</div>
    ...
    <div class="row">
		...
		<div class="col-sm-5">
		<input type="text" name="loc" class="form-control"/></div>
	</div>
    ...
    <div class="row">
		...
		<div class="col-sm-5">
		<input type="mail" name="mail" class="form-control"/></div>
	</div>
...
<?php
 ...
 /*
      ...
      $cname = $_POST['cname'];
        ...
        $insert = $db->query("INSERT into company (cname,image,jpro,rpost,ec,package,date,loc,mail) VALUES ('$cname','$imgContent','$profile','$rpost','$ec','$package','$date','$loc','$mail')");
        if($insert){
             echo "<script type ='text/javascript'>alert('Company details added!'); window.location='display_companies.php';</script>"; 
        }else{
