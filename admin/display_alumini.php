          ...
          <ul class="nav nav-sidebar">
            ...
            <li><a href="index.php?page=manage_users"><span class="glyphicon glyphicon-user"></span> Manage Users</a></li>
			 <li><a href="index.php?page=notification"><span class="glyphicon glyphicon-envelope"></span> Manage  Notification</a></li>
              <li><a href="display_feed.php"><span class="glyphicon glyphicon-envelope"></span> Manage feedback</a></li>
...
$db = getDbInstance();
// select the columns
$select = array('id', 'name', 'branch', 'cname', 'package');
...
$customers = $db->arraybuilder()->paginate("alumini", $page, $select);
...
if(!$rr)
{
echo "<h2 style='color:red'>No details</h2>";
?>
<h4 style="color:Blue"><b><a href="add_admin.php">Add alumini Details</a></b></h4>
<?php
}
else
{
?>
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <h1 class="page-header">Alumini Details</h1>
        </div>
        <div class="col-lg-6" style="">
            <div class="page-action-links text-right">
	            <a href="add_alumini.php">
    ...
    <table class="table table-striped table-bordered table-condensed">
        ...
        <tbody>
            <?php foreach ($customers as $row) : ?>
                <tr>
	                 <td><?php echo htmlspecialchars($row['id']);$id =  $row['id']; ?></td>
	              ...
	              <td><a href="<?= 'update_alumini.php?id='.$row['id']?>" onclick="return confirm('Are you sure?');" style='color:green'><span class='glyphicon glyphicon-edit'></span></a></td>
<td>
                        <a href="display_alumini.php?delete=<?php echo $id ;?>"   class="btn btn-danger delete_btn" data-toggle="modal"  style="margin-right: 8px;"><span class="glyphicon glyphicon-trash"></span></a></td>
				</tr>
...
<!--    Pagination links-->
 ...
 $conn = mysqli_connect('localhost','root','','mysqli_login2') or die("error!");
  if(isset($_GET['delete'])){
        ...
        mysqli_query($conn,"DELETE FROM alumini WHERE id='$delete_id'");
       echo "<script type ='text/javascript'>alert('deleted!'); window.location='display_alumini.php';</script>"; 
