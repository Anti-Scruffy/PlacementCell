...
<form method="post"  style="width:50%;">
	<?php 
    $query = mysqli_query($conn, "SELECT * FROM alumini WHERE id='$id'");
	...
	<div class="row">
		...
		<div class="col-sm-5">
		<input type="text" name="uname"  value="<?= $row['name'];?>" class="form-control" placeholder="name"/></div>
	</div>
	...
	<div class="row">
		...
		<div class="col-sm-5">
		<input type="text" name="cname"  value="<?= $row['cname'];?>" class="form-control" placeholder="Companay name"/></div>
	</div>
	...
	<div class="row">
		...
		<div class="col-sm-5">
		<input type="text" name="package"  value="<?= $row['package'];?>" class="form-control" placeholder="package"/></div>
	</div>
...
<?php
    if(isset($_POST['submit']))
    {
        ...
        //insert
       $query = mysqli_query($con, "UPDATE `alumini` SET `name` = '$user', `branch` = '$branch', `cname` = '$cname', `package` = '$package' WHERE `alumini`.`id` ='$id'");
