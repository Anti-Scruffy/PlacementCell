...
if(isset($_POST['btn-signup'])) {
	...
	if ($count==0) {
		...
		$query = "INSERT INTO tbl_users(username,fname,lname,email,password) VALUES('$uname','$fname','$lname','$email','$hashed_password')";
       ...
       <form class="form-signin" method="post" id="register-form" style="width:30%;margin-left:auto;margin-right:auto;">
        ...
        <div class="form-group">
           ...
           <input type="reset" name="reset"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
             <a href="add_profile.php"><input type="button" class="btn btn-default" name="btn-signup" value="Profile Details"/></a>
        </div> 
